...
const EarningsCard: React.FC = () => {
  ...
  const { data, error, loading } = useFetch(`${BACKEND_URL}/api/v1/admin/balance`, true);
  ...
  const handlePayout = async() => {
    try {
      ...
      const response = await axios.post(`${BACKEND_URL}/api/v1/admin/payout`, {
        ...
        <Card className="bg-white shadow-lg">
          <div className="flex space-x-20">
            <div>
              <CardContent>
                <CardHeader>
                  <CardTitle className="text-primary">Current Earnings</CardTitle>
                </CardHeader>
            ...
            <div>
              <CardContent>
                <CardHeader>
                  <CardTitle className="text-primary">Total Withdrawal</CardTitle>
                </CardHeader>
                <p className="text-4xl font-bold text-primary text-center">
